...
class ModbusCommunication:
    ...
    def configure(self, connection_type=None, **kwargs):
        ...
        # Always use a real connection; simulation_mode removed
        ...
        try:
            ...
            if self.connection_type == 'rtu' and hasattr(self.client, 'port'):
                ...
                if not os.path.exists(port) and not port.startswith('COM'):
                    ...
                    self.connected = False
                    return False
            # For TCP, verify host reachability
...
class DataReader:
    ...
    def reload(self):
        ...
        if demo_mode:
            ...
            self.connected = True
            return
        # Use QSettings for consistency; settings not used directly here.
